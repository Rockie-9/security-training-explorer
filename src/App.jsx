...
const ALL_DATA = [
  ...
  { id:"AA06", cat:"aidx", cert:"Claude Code in Action", certFull:"Claude Code 實戰", org:"Anthropic Academy", focus:"將 Claude Code 整合到開發工作流程 — 命令列 AI 助手，直接在終端機進行程式碼生成、除錯與重構。", focusEn:"Integrate Claude Code into dev workflow — command-line AI assistant for code generation, debugging & refactoring directly in terminal.", prereq:"開發者，熟悉命令列", prereqEn:"Developer, comfortable with CLI", cost:"免費（含證書）", costVal:0, costNote:"免費。深入檔案操作、context 管理、GitHub 工作流程、hooks 與 Claude Code SDK。", costNoteEn:"Free. Covers file ops, context management, GitHub workflows, hooks & the Claude Code SDK.", mode:"自學實作課程。", modeEn:"Self-paced hands-on.", tier:"advanced", priority:"recommended", complianceTag:null, pathOrder:25, url:"https://anthropic.skilljar.com/claude-code-in-action", verified:"verified" },
  { id:"AA07", cat:"aidx", cert:"Claude Code 101", certFull:"Claude Code 入門", org:"Anthropic Academy", focus:"Claude Code 首選入門課。安裝設定（終端機/VS Code/JetBrains）、Explore-Plan-Code-Commit 工作流程、CLAUDE.md 專案記憶與 MCP 整合。", focusEn:"The recommended first course for Claude Code. Installation (terminal/VS Code/JetBrains), Explore-Plan-Code-Commit workflow, CLAUDE.md project memory & MCP integration.", prereq:"基礎程式設計概念", prereqEn:"Basic programming concepts", cost:"免費（含證書）", costVal:0, costNote:"免費。2026 年 4 月新增課程，建議先修此課再上 Claude Code in Action。", costNoteEn:"Free. Added April 2026; take before Claude Code in Action.", mode:"自學線上課程，約1小時。", modeEn:"Self-paced, ~1 hour.", tier:"mid", priority:"recommended", complianceTag:null, pathOrder:26, url:"https://anthropic.skilljar.com/claude-code-101", verified:"verified" },
  { id:"AA08", cat:"aidx", cert:"Introduction to Claude Cowork", certFull:"Claude Cowork 入門", org:"Anthropic Academy", focus:"非開發者的代理式知識工作。用 Claude Cowork 處理文件、簡報、試算表等桌面工作流程 — 專為行政與知識工作者設計。", focusEn:"Agentic knowledge work for non-developers. Use Claude Cowork for documents, decks, spreadsheets & desktop workflows — designed for admin & knowledge workers.", prereq:"無經驗要求", prereqEn:"No experience required", cost:"免費（含證書）", costVal:0, costNote:"免費。2026 年 4 月新增課程。", costNoteEn:"Free. Added April 2026.", mode:"自學線上課程。", modeEn:"Self-paced online.", tier:"entry", priority:"recommended", complianceTag:null, pathOrder:27, url:"https://anthropic.skilljar.com/introduction-to-claude-cowork", verified:"verified" },
  { id:"AA09", cat:"aidx", cert:"Claude Agent Skills", certFull:"Claude Agent Skills 課程", org:"Anthropic Academy", focus:"建構與管理 Agent Skills — 從撰寫 SKILL.md、團隊工作流程共享、除錯，到組織級部署，讓 Claude 自動套用一致的專業行為。", focusEn:"Build & manage Agent Skills — from writing SKILL.md files to sharing team workflows, troubleshooting & organization-wide deployment for consistent behavior.", prereq:"Claude Code 基礎", prereqEn:"Claude Code basics", cost:"免費（含證書）", costVal:0, costNote:"免費。2026 年 4 月新增課程，與 Subagents 課程互補。", costNoteEn:"Free. Added April 2026; complements the Subagents course.", mode:"自學實作課程。", modeEn:"Self-paced hands-on.", tier:"advanced", priority:"elective", complianceTag:null, pathOrder:28, url:"https://anthropic.skilljar.com/claude-agent-skills", verified:"verified" },
  { id:"CCA", cat:"aidx", cert:"Claude Certified Architect — Foundations", certFull:"Claude 認證架構師（基礎級）", org:"Anthropic (Claude Partner Network)", focus:"Anthropic 首個正式技術認證（2026-03-12 推出）。驗證以 Claude 建構生產級系統的架構能力，代理式架構與 Claude Code 佔比最高。監考測驗，非完課證書。", focusEn:"Anthropic's first formal technical certification (launched 2026-03-12). Validates production Claude system architecture; agentic architecture & Claude Code weighted highest. Proctored exam, not a completion certificate.", prereq:"生產級 Claude 開發經驗；經 Claude Partner Network 申請", prereqEn:"Production Claude experience; access via Claude Partner Network", cost:"US$99", costVal:99, costNote:"考試費 $99；60 題監考測驗 / 120 分鐘，及格線 720/1000。Partner Network 免費加入。後續將推出 seller / developer / 進階架構師層級。", costNoteEn:"$99 exam; 60Q proctored / 120 min, pass 720/1000. Partner Network free to join. Seller/developer/advanced tiers coming later in 2026.", mode:"線上監考測驗（ProctorFree）。", modeEn:"Online proctored exam (ProctorFree).", tier:"advanced", priority:"elective", complianceTag:null, pathOrder:29, url:"https://www.anthropic.com/news/claude-partner-network", verified:"verified", scopeNote:"🎯 正式證照：與課程完課證書不同，為業界首個 AI 原生監考技術認證。", scopeNoteEn:"🎯 Formal credential: distinct from course certificates — the first proctored AI-native technical certification." },
  { id:"OA01", cat:"aidx", cert:"OpenAI Academy: AI Foundations", certFull:"OpenAI Academy AI 基礎", org:"OpenAI Academy", focus:"AI、大型語言模型與 ChatGPT 實務入門。提示、脈絡提供、輸出檢核與負責任使用的核心習慣。廠商多元化的免費入門選項。", focusEn:"Practical intro to AI, LLMs & ChatGPT. Core habits: prompting, context, output review & responsible use. Vendor-diverse free entry option.", prereq:"無經驗要求（需 ChatGPT 帳號）", prereqEn:"No experience required (ChatGPT account needed)", cost:"免費（含完課證書）", costVal:0, costNote:"免費，全球開放，60–75 分鐘。注意：正式 OpenAI Certification 為另一體系，目前僅限企業試點（Walmart、BCG、Accenture 等），個人無法自行報名。", costNoteEn:"Free, globally available, 60-75 min. Note: the formal OpenAI Certification is a separate program, currently employer-pilot only (Walmart, BCG, Accenture) — no individual self-enrollment.", mode:"自學線上課程（Gradual 平台）。", modeEn:"Self-paced online (Gradual platform).", tier:"entry", priority:"elective", complianceTag:null, pathOrder:30, url:"https://academy.openai.com/", verified:"verified" },
  { id:"AAISM", cat:"aidx", cert:"AAISM (ISACA AI Security Management)", certFull:"ISACA 進階 AI 安全管理認證", org:"ISACA", focus:"首個以 AI 為中心的安全管理認證。三大領域：AI 治理與計畫管理 31%、AI 風險與機會管理 31%、AI 技術與控制 38%。對應 EU AI Act 與 NIST AI RMF。", focusEn:"First AI-centric security management certification. Domains: AI Governance & Program Mgmt 31%, AI Risk & Opportunity 31%, AI Technologies & Controls 38%. Aligns with EU AI Act & NIST AI RMF.", prereq:"須持有效 CISM 或 CISSP", prereqEn:"Active CISM or CISSP required", cost:"考試 $459 (會員) / $599 (非會員)", costVal:649, costNote:"考試 $459/$599 + 申請費 $50 + 年費 $20/$35。官方線上課程 $449/$549。每年 10 CPE、三年 30 CPE。", costNoteEn:"Exam $459/$599 + $50 application + $20/$35 annual. Official online course $449/$549. 10 CPE/yr, 30 CPE/3yr.", mode:"電腦測驗（PSI 考場或遠端監考），及格線 450/800。", modeEn:"Computer exam (PSI centers or remote proctored), pass 450/800.", tier:"advanced", priority:"elective", complianceTag:null, pathOrder:31, url:"https://www.isaca.org/credentialing/aaism", verified:"verified", scopeNote:"🔐 先決條件：須持有效 CISM 或 CISSP，適合資安背景或雙軌發展的主管與工程師。", scopeNoteEn:"🔐 Prerequisite gate: active CISM or CISSP required — suited to managers/engineers with infosec background or dual-track development." },
];
...
const BENCHMARK = {
  ...
  CCA: { companies:["Anthropic","Claude Partner Network members","Major consulting firms"], sectors:["AI Engineering","Solution Architecture","Enterprise Consulting"], regionsEn:"Global", regionsZh:"全球", noteEn:"First proctored AI-native technical certification from a major AI lab (Mar 2026). Consulting firms are beginning to list Claude expertise as a delivery requirement; additional seller/developer/advanced tiers announced for later 2026.", noteZh:"首個由主要 AI 實驗室推出的監考式 AI 原生技術認證（2026 年 3 月）。顧問公司已開始將 Claude 專業列為交付要求；seller / developer / 進階層級將於 2026 年稍後推出。" },
  OA01: { companies:["OpenAI","Walmart","BCG","Accenture","John Deere (cert pilots)"], sectors:["All Industries","Workforce Training"], regionsEn:"Global (Academy courses); US-centric (formal certification pilots)", regionsZh:"全球（Academy 課程）；正式認證試點以美國為主", noteEn:"OpenAI targets 10M certifications by 2030 via a workforce-training model backed by ETS and Credly/Pearson. Academy courses are free & global; the formal certification remains employer-gated as of mid-2026.", noteZh:"OpenAI 目標 2030 年前認證 1,000 萬人，由 ETS 與 Credly/Pearson 支持心理計量標準。Academy 課程免費且全球開放；正式認證至 2026 年中仍限企業試點。" },
  AAISM: { companies:["ISACA","Finance & tech firms listing AAISM as preferred","Government AI governance programs"], sectors:["AI Governance","Security Management","Risk & Compliance"], regionsEn:"Global (PSI centers + remote proctoring)", regionsZh:"全球（PSI 考場 + 遠端監考）", noteEn:"Launched Aug 2025 as the first AI-centric security management certification. Domains align with EU AI Act and NIST AI RMF; finance and technology firms have begun listing it as a preferred credential for AI governance roles.", noteZh:"2025 年 8 月推出，為首個以 AI 為中心的安全管理認證。領域對應 EU AI Act 與 NIST AI RMF；金融與科技業已開始將其列為 AI 治理職位的優先認證。" },
};
...
const ROLES = [
  ...
  { id:"engineer_sp", icon:Wrench, color:"#0891B2",
    ...
    courses:["S5","C1","C7","C3","S8","S9","S1","S2","AA01","E05","I02","I08","AA04","AA05","AA07","AA06","AA09","A05","A08","CCA"],
    ...
    phases:[ ["S5","C1","C7","C3"], ["S8","S9"], ["S1","S2"], ["AA01","E05","I02","I08"], ["AA04","AA05","AA07","AA06","AA09","A05","A08","CCA"] ],
  },
  ...
  { id:"secretary", icon:BookOpen, color:"#FB7185",
    ...
    courses:["R4","S1","R1","AA01","AA02","AA08","E01","E05","E06","E03","I01","I04"],
    ...
    phases:[ ["R4","R1"], ["S1"], ["AA01","AA02","AA08","E01","E05","E06","E03"], ["I01","I04"] ],
  },
  ...
  return (
    <div style={{ ...themes[theme], fontFamily:"'Noto Sans TC','DM Sans',system-ui,sans-serif", background:"var(--bg)", color:"var(--text-1)", minHeight:"100vh" }}>
      ...
      <div style={{padding:"12px 24px",borderTop:"1px solid var(--border)",textAlign:"center",fontSize:10,color:"var(--text-3)"}}>
        {t("Security Training Explorer v7.2 · GSM / GPS · Verified 2026-07-07 · Incl. CCA, AAISM, OpenAI Academy",
           "全球實體安全訓練檢索 v7.2 · GSM / GPS · 查核日期 2026-07-07 · 新增 CCA、AAISM、OpenAI Academy")}
      </div>
    </div>
  );
}
